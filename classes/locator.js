...
class Locator {
    ...
    getURLByCoords(longitude, latitude) {
        return `https://restapi.amap.com/v3/geocode/regeo?key=${token}&location=${longitude},${latitude}`
    }
}

const token = '978b6f784d5b7eac6ccf9f448a4541af'
